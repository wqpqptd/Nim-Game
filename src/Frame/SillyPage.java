 ...
 * @author tuongdi
 */
public class SillyPage extends javax.swing.JFrame {
    ...
    public void coke() {
        ...
        if (JOptionPane.showConfirmDialog(this, "Bạn có muốn chơi trước?", "Xác nhận", JOptionPane.YES_NO_OPTION) == JOptionPane.NO_OPTION) {
            amount = silly.move(pile.getAmount());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SillyPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
