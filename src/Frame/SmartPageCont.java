 ...
 * @author tuongdi
 */
public class SmartPageCont extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SmartPageCont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
